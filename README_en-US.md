...
Lightweight system-tray app · Local compositing · Current version **v1.5.0**
...
Full CLI reference: [doc/cli-arguments.md](doc/cli-arguments.md). Changelog: [CHANGELOG.md](CHANGELOG.md).
